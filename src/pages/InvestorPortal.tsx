      ...
      <section className="py-12 px-4 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Generate customised, branded legal documents for investor and partnership conversations.</p>
          </div>
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription>Mutual NDA — POPIA compliant</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Protect confidential information before sharing financials, platform data, or partnership details. Supports investment, partnership, tech, and employment contexts.
                </p>
                <Button asChild className="w-full">
                  <Link to="/legal/nda">
                    Generate NDA <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
              </CardContent>
            </Card>
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg">Revenue-Share Agreement</CardTitle>
                    <CardDescription>Investment tiers & association partnerships</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Covers Founders' Seed, Implementation Partner, Hybrid Revenue-Share, and Taxi Association deals. Pre-filled terms for each tier.
                </p>
                <Button asChild className="w-full">
                  <Link to="/legal/revenue-share">
                    Generate Agreement <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
              </CardContent>
            </Card>
