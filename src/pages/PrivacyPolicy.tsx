        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                PoortLink (a MobilityOne (Pty) Ltd platform) respects your privacy and is committed to protecting your personal information in accordance with the Protection of Personal Information Act (POPIA) of South Africa.
              </CardDescription>
            </CardHeader>
            <CardContent>
